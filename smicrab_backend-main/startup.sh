...
# Step 1: Build all Docker images including analysis images
...
# Step 3: Create datasets_csv directory if it doesn't exist
log "Creating datasets_csv directory..."
mkdir -p ./datasets_csv || error "Failed to create datasets_csv directory."
success "datasets_csv directory created/verified."

# Step 4: Validate datasets and run R setup
...
# Step 6: Start backend (and ensure it's running)

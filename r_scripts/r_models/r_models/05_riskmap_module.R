...
tryCatch(
  {
      ...
      tryCatch(
        {
          ...
          output <- capture.output({
            cat(paste("\n--WARNING--: \n\nThe following linear regression model is made for explorative purposes.",
                      "\nIt uses as regression data the fitted DIFF values and the estimated coefficients of the H-SDPD model,\nalong with some additional exogenous covariates, observed in Italy.",
                      "\nThe model aims to investigate the global factors that influence the variability of the DIFF measure.",
                      "\nAlthough it is based on the estimation results of a spatio-temporal model, \nit may suffer for some inefficiency due to residual spatial correlation in the regression data.\n",
                      "\n-----------\n\n "))
    ...
    if (user_model_choice == "Model1_Simple") {
      ...
      if (exists("TrendSens_df")) {
        ...
        tryCatch(
          {
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_beta_sens"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            ...
            plt_sig_sens <- TrendSens_df[[name.endogenous]] %>%
              ...
              ggtitle(paste(name.endogenous, " (Significant tests at level ", pars_alpha * 100, "%)", sottotitolo2, sep = "")) +
              theme_bw()
            save_plot(plt_sig_sens, paste0("sens_significant_pixels", if (bool_dynamic) ".html" else ".png"), output_dir, bool_dynamic)
            
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_sig_sens_BY"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            plt_sig_sens_BY <- TrendSens_df[[name.endogenous]] %>%
              ...
              guides(fill = "none") +
              labs(x = "Longitude", y = "Latitude", col = "Trend\n coefficient:", subtitle = sottotitolo) +
              ggtitle(paste(name.endogenous, "  (Significant tests with BY correction at level ", pars_alpha * 100, "%)", sottotitolo2, sep = "")) +
              theme_bw()
      ...
      if (exists("TrendCS_df")) {
        ...
        tryCatch(
          {
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_beta_cs"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            ...
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_sig_cs"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            ...
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_sig_cs_BY"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
      ...
      if (exists("TrendMK_df")) {
        ...
        tryCatch(
          {
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_beta_mk"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            ...
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_sig_mk"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            ...
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_sig_mk_BY"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
      ...
      if (exists("TrendSMK_df")) {
        ...
        tryCatch(
          {
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_beta_smk"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            plt_beta_smk <- TrendSMK_df[[name.endogenous]] %>%
              ...
              scale_color_gradient2(high = "red", low = "blue", mid = "grey90", midpoint = 0) +
              guides(fill = "none") +
              labs(y = "Latitude", x = "Longitude", col = "Trend-statistic", subtitle = sottotitolo) +
              ggtitle(paste(name.endogenous, sottotitolo2, sep="")) +
              theme_bw()
            save_plot(plt_beta_smk, paste0("smk_estimates", if (bool_dynamic) ".html" else ".png"), output_dir, bool_dynamic)
            
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_sig_smk"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            ...
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_sig_smk_BY"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
      ...
      if (exists("TrendPWMK_df")) {
        ...
        tryCatch(
          {
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_beta_pwmk"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            ...
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_sig_pwmk"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            ...
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_sig_pwmk_BY"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
      ...
      if (exists("TrendBCPW_df")) {
        ...
        tryCatch(
          {
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_beta_bcpw"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            ...
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_sig_bcpw"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            ...
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_sig_bcpw_BY"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
      ...
      if (exists("TrendRobust_df")) {
        ...
        tryCatch(
          {
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_beta_robust"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            ...
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_beta_robust_sd"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            plt_beta_robust_sd <- TrendRobust_df[[name.endogenous]] %>%
              ...
              scale_color_gradient2(high = "red", low = "blue", mid = "grey90", midpoint = 0) +
              guides(fill = "none") +
              labs(y = "Latitude", x = "Longitude", col = "std.error", subtitle = sottotitolo) +
              ggtitle(paste(name.endogenous, sottotitolo2, sep="")) +
              theme_bw()
            ...
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_sig_robust"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            ...
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_sig_robust_BY"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
        ...
        tryCatch(
          {
            ...
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_score"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
        ...
        tryCatch(
          {
            ...
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_mv"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            plt_mv <- mv$Vote %>%
            ...
            sottotitolo2 <- NULL
            sottotitolo <- captions_list[["plt_mv_BY"]]
            if(bool_dynamic)
              sottotitolo2 <- paste("\n", sottotitolo, sep="")
            plt_mv_BY <- mv$Vote_BY %>%
              ...
              guides(fill = "none") +
              labs(x = "Longitude", y = "Latitude", col = "Trend\n coefficient:", subtitle = sottotitolo) +
              ggtitle(paste(name.endogenous, " (majority vote with BY correction at level ", pars_alpha, "%)", sottotitolo2, sep="")) +
              theme_bw()
    ...
    if (user_model_choice %in% c("Model4_UHU", "Model5_RAB", "Model6_HSDPD_user", "Model6_UserDefined") && exists("df.results.estimate")) {
      log_info("Models 4, 5, and 6: Spatio-temporal H-SDPD Analysis")
      
      # Use bootstrap results
      results_data <- df.results <- df.results.test |>
      ...
      dati.intercept <- data.frame(px=df.results$px, longitude=df.results$lon, latitude=df.results$lat, district=df.results$district,
        estimate=df.results$coeff.hat$intercept_norm, stdev=df.results$coeff.sd.boot$intercept_norm, pvalue=df.results$pvalue.test$intercept_norm) |>
        left_join(slc_df) |>
      ...
      dati.slopes0 <- data.frame(px=df.results$px, longitude=df.results$lon, latitude=df.results$lat, estimate=df.results$coeff.hat$slope_norm, stdev=df.results$coeff.sd.boot$slope_norm, pvalue=df.results$pvalue.test$slope_norm) |>
        mutate(sig_trend=pvalue < pars_alpha) |>
        mutate(trend1=ifelse(estimate > 0 & sig_trend==TRUE,1,0)) |>
        mutate(trend2=ifelse(estimate < 0 & sig_trend==TRUE,-1,0)) |>
        mutate(trend_sdpd=factor(trend1+trend2)) |>
      ...
      limite <- threshold.climate.zones # (see settings)
      ...
      dati.HI <- df.results |>
        ...
        left_join(dati.slopes0, by=join_by(px, longitude, latitude)) |>
        select(-c(stdev, pvalue, slope_test, p.value_BY)) |>
      ...
      tryCatch(
        {
          sottotitolo2 <- NULL            
          sottotitolo <- paste("Model: ", name.endogenous, " ~ H-SDPD, based on data from ",   range(tt.date)[1], " to ", range(tt.date)[2], sep="")
          if(bool_dynamic){
            sottotitolo2 <- paste("\n", sottotitolo, sep="")
            sottotitolo <- NULL
          }
          ...
          if ("coeff.hat" %in% names(results_data) && "trend" %in% names(results_data$coeff.hat)) {
            plt_SDPD_estimates <- results_data %>%
              ...
              scale_color_gradient2(high = "red", low = "blue", mid = "white", midpoint = 0) +
              guides(fill = "none") +
              labs(y = "Latitude", x = "Longitude", col = "Trend\ncoefficient\nestimate:", subtitle = sottotitolo) +
              ggtitle(paste("Trend estimation map", sottotitolo2, sep=""))
          ...
          if (exists("df.results.test") && "coeff.sd.boot" %in% names(df.results.test) && "trend" %in% names(df.results.test$coeff.sd.boot)) {
            plt_SDPD_std <- df.results.test %>%
              ...
              guides(fill = "none") +
              labs(y = "Latitude", x = "Longitude", col = "Std. Error", subtitle = sottotitolo) +
              ggtitle(paste("Trend Standard Errors map", sottotitolo2, sep=""))
          ...
          if (exists("df.results.test") && "pvalue.test" %in% names(df.results.test)) {
            ...
            plt_sdpd <- dati %>%
              ...
              guides(fill = "none") +
              labs(x = "Longitude", y = "Latitude", col = paste("Test\nresult\n(size ", pars_alpha * 100, "%)", sep=""), subtitle = sottotitolo) +
              ggtitle(paste("Trend: univariate significance test", sottotitolo2, sep=""))
            ...
            plt_SDPD_sig_BY <- dati %>%
              ...
              scale_color_manual(values = c("Neg" = "blue", "Null" = "white", "Pos" = "red")) +
              guides(fill = "none") +
              labs(x = "Longitude", y = "Latitude", col = paste("BY test\nresult\n(size ", pars_alpha * 100, "%)", sep=""), subtitle = sottotitolo) +
              ggtitle(paste("Trend: BY-Adjusted global significance test", sottotitolo2, sep=""))
        ...
        tryCatch(
          {
            ...
            plt_trend_lc <- slc_df %>%
              ...
              geom_point(size = size.point) +
              guides(fill = "none") +
              labs(x = "Longitude", y = "Latitude", title = "Land Cover Map for Trend Regression", col = "LC", subtitle = captions_list[["plt_FE_lc"]]) +
              theme_bw()
      ...
      # 3. SPATIO-TEMPORAL Absolute DIFF measure ANALYSIS
        ...
        tryCatch(
          {
            ...
            plt_FE_estimates <- df.results %>%
              ggplot(aes(x = lon, y = lat, col = coeff.hat$abs_diff)) +
              geom_point(size = size.point) +
              scale_color_gradient2(high = "red", low = "blue", mid = "white", midpoint = 0) +
              guides(fill = "none") +
              labs(y = "Latitude", x = "Longitude", col = pars_list[[name.endogenous]]$unit, subtitle = sottotitolo) +
              ggtitle(paste("Absolute DIFF estimation map", sottotitolo2, sep=""))

            save_plot(plt_FE_estimates, paste0("fixed_effects_estimates_map", if (bool_dynamic) ".html" else ".png"), output_dir, bool_dynamic)
            
            # abs DIFF Standard Errors (if bootstrap results available)
            if (exists("df.results.test") && "coeff.sd.boot" %in% names(df.results.test) && "fixed_effects" %in% names(df.results.test$coeff.sd.boot)) {

              limiti <- quantile(df.results$coeff.sd.boot$abs_diff, probs=c(0.001, 0.999))
              plt_FE_std <- df.results %>%
                ggplot(aes(x = lon, y = lat, col = coeff.sd.boot$abs_diff)) +
                geom_point(size = size.point) +
                scale_color_gradient2(high = "red", low = "blue", mid = "white", midpoint = 0, limits=limiti) +
                guides(fill = "none") +
                labs(y = "Latitude", x = "Longitude", col = "std.error:", subtitle = sottotitolo) +
                ggtitle(paste("Absolute DIFF Standard Errors map", sottotitolo2, sep=""))
            ...
            if (exists("df.results.test") && "pvalue.test" %in% names(df.results.test) && "fixed_effects" %in% names(df.results.test$pvalue.test)) {
              ...
              plt_FE_sdpd <- dati.HI %>%
                select(longitude, latitude, district, LC, zone, Intercept_norm, Slope_norm, mu.i) |>
                ggplot(aes(x = longitude,  y = latitude, district=district, LC=LC, col = mu.i)) +
                geom_point(size = size.point) +
                scale_colour_gradientn(colours=c("blue", "red")) + 
                guides(fill = "none") +
                labs(x="Longitude", y="Latitude", col=pars_list[[name.endogenous]]$unit,  subtitle=sottotitolo) + 
                ggtitle(paste("Fitted temporal mean for ", name.endogenous, sottotitolo2, sep=""))
              
              save_plot(plt_FE_sdpd, paste0("significant_fixed_effects_map", if (bool_dynamic) ".html" else ".png"), output_dir, bool_dynamic)
              
              # BY-adjusted significant pixels for abs DIFF
              plt_FE_sig_BY <- dati.HI %>%
                select(longitude, latitude, district, LC, zone, condition_test_BY, mu.i) |>
                ggplot(aes(x = longitude, y = latitude, col = condition_test_BY)) +
                geom_point(size = size.point) +
                scale_color_manual(values = c("Cold" = "blue", "Null" = "white", "Heat" = "red")) +
                guides(fill = "none") +
                labs(x = "Longitude", y = "Latitude", col = paste("Test\nresult\n(size ", pars_alpha * 100, "%)", sep=""), subtitle = sottotitolo) +
                ggtitle(paste("BY-Adjusted global test for DIFF measure", sottotitolo2, sep=""))

              save_plot(plt_FE_sig_BY, paste0("by_adjusted_fixed_effects_map", if (bool_dynamic) ".html" else ".png"), output_dir, bool_dynamic)
              
              # Abs DIFF Summary Statistics
              
              row1 <- table(factor(dati.HI$condition_test, levels=c("Cold", "Null", "Heat")))
              row2 <- table(factor(dati.HI$condition_test_BY, levels=c("Cold", "Null", "Heat")))
              dati <- data.frame(as.vector(row1), paste(round(prop.table(row1)*100, 1), "%", sep=""), 
                                 as.vector(row2), paste(round(prop.table(row2)*100, 1), "%", sep=""))
              dimnames(dati)[[1]] <- c("COLD: Negative abs DIFF measure", "Null: abs DIFF measure=0", "HEAT: Positive abs DIFF measure")
              dimnames(dati)[[2]] <- c("Pixels", "%", "Pixels (BY adjusted)", "%")
              
              save_table(dati, "fixed_effects_summary_table.html", output_dir, bool_dynamic)
            }
          },
          error = function(e) {
        ...
        tryCatch(
          {
            ...
            plt_FE_lc_regression <- slc_df %>%
              ...
              geom_point(size = size.point) +
              guides(fill = "none") +
              labs(x = "Longitude", y = "Latitude", title = "Land Cover Map", col = "LC", subtitle = captions_list[["plt_FE_lc"]])
